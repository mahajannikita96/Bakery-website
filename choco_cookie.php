...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <img src="images/choco1.jpg" alt="Image" class="auto-style2" />
                <form method = "POST" action="add_to_cart1.php" id="1">
                        <input type="hidden" name="cookiename" value="chocolate"><h2>Chocolates</h2><br />
                    <div class="row">
                        <div class="col-md-3">
                             <b>Quantity</b>
                        </div>
            ...
            <div class="col-md-4">
                ...
                <form method = "POST" action="add_to_cart1.php" id="2">
            ...
            <div class="col-md-4">
                ...
                <form method = "POST" action="add_to_cart1.php" id="3">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <form method = "POST" action="add_to_cart1.php" id="4">
            ...
            <div class="col-md-4">
                ...
                <form method = "POST" action="add_to_cart1.php" id="5">
            ...
            <div class="col-md-4">
                ...
                <form method = "POST" action="add_to_cart1.php" id="6">
