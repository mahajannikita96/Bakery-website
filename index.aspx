		...
		<div>
			...
			<div id="section" class="auto-style2">
				<ul class="auto-style7">
					<li class="auto-style4"><a href="Productlist2.aspx">Seasonal cakes</a></li>
					<li class="auto-style5"><a href="product.aspx">paestries</a></li>
                    <li><a href="Productlist8.aspx"> Gannache & Mousse </a></li>
                    <li class="auto-style4"><a href="product.aspx">speciality cakes</a></li>
					<li class="auto-style6"><a href="product.aspx">special occasion cakes</a></li>
					<li><a href="product.aspx">wedding cakess</a></li>
					<li><a href="product.aspx">tarts and Flans</a></li>
					<li><a href="product.aspx">Chocolates,Bread and pies</a></li>
                    <li><a href="Productlist9.aspx" class="auto-style1">cookies</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </li>
				</ul>
				<a href="index.aspx"><img src="images/CreamCafe.gif" alt="Image" class="auto-style3"/></a>
			</div>
		</div>
	</div>
	<div id="content">
		...
		<div class="home">
			<div>
				...
				<div class="section">
					<div>
						<div>
							<h3><a href="index.aspx">Daily Cake Surprise</a></h3>
							<p></p>
						</div>
					</div>
				</div>
